...
class ApiEndpointWriteBodyListInner(BaseModel):
    """
    ApiEndpointWriteBodyListInner
    """ # noqa: E501
    node_id: StrictInt = Field(description="ID of the node to write to")
    eps: List[Dict[str, Any]] = Field(description="List of endpoint values to write")
    __properties: ClassVar[List[str]] = ["node_id", "eps"]
