...
class ApiEndpointReadBody(BaseModel):
    """
    ApiEndpointReadBody
    """ # noqa: E501
    list: List[ApiEndpointReadBodyListInner] = Field(description="List of nodes and endpoints to read")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": [ApiEndpointReadBodyListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
