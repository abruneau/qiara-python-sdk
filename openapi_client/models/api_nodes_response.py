...
class ApiNodesResponse(BaseModel):
    """
    ApiNodesResponse
    """ # noqa: E501
    hash_i: StrictInt = Field(description="Hash value for the node list")
    list: List[Node] = Field(description="List of nodes (devices) in the system")
    __properties: ClassVar[List[str]] = ["hash_i", "list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hash_i": obj.get("hash_i"),
            "list": [Node.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
