...
class ApiEndpointWriteBody(BaseModel):
    """
    ApiEndpointWriteBody
    """ # noqa: E501
    list: List[ApiEndpointWriteBodyListInner] = Field(description="List of nodes and endpoints to write")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": [ApiEndpointWriteBodyListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
