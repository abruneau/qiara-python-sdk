...
class ApiEndpointReadBodyListInner(BaseModel):
    """
    ApiEndpointReadBodyListInner
    """ # noqa: E501
    node_id: StrictInt = Field(description="ID of the node to read from")
    eps: List[StrictStr] = Field(description="List of endpoint names to read")
